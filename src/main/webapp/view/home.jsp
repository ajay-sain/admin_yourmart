...
<body onload="onloadFunction(${pageStart},${contentSize},${totalRecords},'${status}')">
	<header>
		...
		<div class="item-list">
		    ...
		    <div class="table-container">
		        ...
		        <div class="seacrh-box">
		            <select class="filter-box" onChange="filter(this.value)" id="select">
		                ...
		                <form:form action="/admin_yourmart/status-update" method="POST" modelAttribute="table">
			                <thead>
			                    <tr class="table-header table-row">
			                        ...
			                        <th class="column-header">
		                        		<a href="javascript:void(0);" onClick="sortTale('sellerId')">
		                        			Seller Id 
			                ...
			                <tbody>
			                	<c:forEach var="i" items="${sellers}">
				                    <tr class="table-row">
				                    	<td class="column-body"><div class="check-box-container"><form:checkbox id="${i.getSellerId()}" name="SellerIds" value="${i.getSellerId()}" class="check-box" path="id"/><label for="${i.getSellerId()}" class="check-box-label" ></label></div></td>
