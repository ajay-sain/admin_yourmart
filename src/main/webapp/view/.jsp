...
<script type="text/javascript" src="/admin_yourmart/javascript/home.js"></script>
</head>
		    ...
		    <div class="table-container">
		        ...
		        <div class="table-box">
		            <table class="product-list">
		                <form:form action="/admin_yourmart/status-update" method="POST" modelAttribute="table">
			                <thead>
			                    <tr class="table-header table-row">
			                    	<th class="column-header"></th>
			                        <th class="column-header">
		                        		<a href="javascript:void(0);" onClick="sortTale('id')">
		                        			Seller Id 
			                        ...
			                        <th class="column-header">Owner Name</th>
			                        <th class="column-header">Email</th>
			                        <th class="column-header mini-column">Telephone</th>
			                        <th class="column-header">
			                        	<a href="javascript:void(0);" onClick="sortTale('status')">
			                        		Status
			                        		<svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 0 1792 1792" ><path d="M1408 1088q0 26-19 45l-448 448q-19 19-45 19t-45-19l-448-448q-19-19-19-45t19-45 45-19h896q26 0 45 19t19 45zm0-384q0 26-19 45t-45 19h-896q-26 0-45-19t-19-45 19-45l448-448q19-19 45-19t45 19l448 448q19 19 19 45z"/></svg>
			                        	</a>
		                        	</th>
			                        <th class="column-header">
			                        	<a href="javascript:void(0);" onClick="sortTale('time')">
			                        		Registration time
			                        		<svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 0 1792 1792" ><path d="M1408 1088q0 26-19 45l-448 448q-19 19-45 19t-45-19l-448-448q-19-19-19-45t19-45 45-19h896q26 0 45 19t19 45zm0-384q0 26-19 45t-45 19h-896q-26 0-45-19t-19-45 19-45l448-448q19-19 45-19t45 19l448 448q19 19 19 45z"/></svg>
			                        	</a>
			                        </th>
			                ...
			                <tbody>
			                	<c:forEach var="i" items="${sellers}">
				                    <tr class="table-row">
				                    	<td class="column-body"><div class="check-box-container"><form:checkbox id="${i.getSellerId()}" name="SellerIds" value="${i.getSellerId()}" class="check-box" path="sellers"/><label for="${i.getSellerId()}" class="check-box-label" ></label></div></td>
				                        <td class="column-body"><c:out value="${i.getSellerId()}" /></td>
				                        <td class="column-body"><c:out value="${i.getCompanyName()}" /></td>
				                        <td class="column-body"><c:out value="${i.getOwnerName()}" /></td>
				                        <td class="column-body"><c:out value="${i.getEmail()}" /></td>
				                        <td class="column-body"><c:out value="${i.getTelephone()}" /></td>
				                        <td class="column-body"><c:out value="${i.getStatus()}" /></td>
				                        <td class="column-body"><c:out value="${i.getRegistrationTime()}" /></td>
				                        <td>
				                            <div>
				                                <a class="button" href="/admin_yourmart/seller?sellerId=${i.getSellerId()} " (click)=edit(item)>
		        ...
		        <div class="table-config">
		            ...
		            <label for="pagination"><c:out value="${pageStart}" />-<c:out value="${contentSize}" /> of <c:out value="${totalRecords}" /></label>
